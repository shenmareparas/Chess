...
class AIEnginePicker extends StatelessWidget {
  final String aiEngine;
  final Function(String) setFunc;

  const AIEnginePicker(this.aiEngine, this.setFunc, {Key? key})
      : super(key: key);
            ...
            children: [
              Expanded(
                child: _buildButton(
                  context: context,
                  label: 'Stockfish AI',
                  isSelected: aiEngine == 'stockfish',
                  theme: theme,
                  primaryColor: primaryColor,
                  activeBgColor: activeBgColor,
                  inactiveTextColor: inactiveTextColor,
                  onTap: () => setFunc('stockfish'),
                ),
              ),
              Expanded(
                child: _buildButton(
                  context: context,
                  label: 'Minimax (Local)',
                  isSelected: aiEngine == 'minimax',
                  theme: theme,
                  primaryColor: primaryColor,
                  activeBgColor: activeBgColor,
                  inactiveTextColor: inactiveTextColor,
                  onTap: () => setFunc('minimax'),
                ),
              ),
            ],
          ),
